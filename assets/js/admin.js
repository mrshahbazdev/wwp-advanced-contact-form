jQuery(document).ready(function($) {
    ...
    if ($('#ccf-form-builder').length) {
        ...
        var fieldTypes = {
            ...
            'select': 'Dropdown', 'checkbox': 'Checkbox', 'radio': 'Radio Buttons', 'file': 'File Upload'
        };
        ...
        $('#ccf-available-fields').on('click', '.ccf-add-field-btn', function() {
            ...
            addFieldToBuilder({ type: type, label: label });
        });
        ...
        $('#ccf-builder-form').on('submit', function(e) {
            ...
            var formData = {
                ...
                form_description: '', // You can add a description field if you want
                fields: []
            };
